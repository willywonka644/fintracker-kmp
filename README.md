...
> **About this repository.** This is a code-only copy, published as a single commit
> without the development history. The app is used daily with real financial data, so
> no database, backup or key is part of this tree — and the issue tracker, which
> discusses real balances, stays where it is.
